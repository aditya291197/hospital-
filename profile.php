 ...
 if(isset($_POST["submitupd"]))
{
	...
	{
$resrec= mysql_query("UPDATE patient SET patlname='$_POST[patlname]', dob='$datad',gender='$_POST[gender]',patfname='$_POST[patfname]',emailid='$_POST[emailid]',contactno ='$_POST[contactno]',address='$_POST[address]',city ='$_POST[city]',	state  ='$_POST[state]',country ='$_POST[country]',bloodgroup='$_POST[blood]',status='$_POST[textarea]'  WHERE patid = '$_SESSION[patid]' ");
}
else
{
	$resrec= mysql_query("UPDATE patient SET patlname='$_POST[patlname]', dob='$datad',gender='$_POST[gender]',patfname='$_POST[patfname]',emailid='$_POST[emailid]',contactno ='$_POST[contactno]',address='$_POST[address]',city ='$_POST[city]',	state  ='$_POST[state]',country ='$_POST[country]',bloodgroup='$_POST[blood]',status='$_POST[textarea]'  WHERE patid = '$_SESSION[patid]' ");
